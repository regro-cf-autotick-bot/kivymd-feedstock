...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/kivymd-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12466&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/kivymd-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `kivymd` can be installed with:

```
conda install kivymd
```

It is possible to list all of the versions of `kivymd` available on your platform with:
